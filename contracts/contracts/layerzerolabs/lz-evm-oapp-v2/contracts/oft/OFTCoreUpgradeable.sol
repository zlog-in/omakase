    ...
    OAppOptionsType3Upgradeable
{
     ...
     */
    function __initializeOFTCore(uint8 _localDecimals, address _endpoint, address _delegate)
        internal
        virtual
        onlyInitializing
    {
     ...
     * @notice For OMA token, the sharedDecimals should be set to 18 (decimalConversionRate = 1), no precision lost during cross-chain transfer.
     */
        ...
        returns (MessagingReceipt memory msgReceipt, OFTReceipt memory oftReceipt)
    {
        ...
        (uint256 amountSentLD, uint256 amountReceivedLD) =
            _sentToken(msg.sender, _sendParam.amountLD, _sendParam.minAmountLD, _sendParam.dstEid);
    ...
    function _receiveToken(address _to, uint256 _amountLD, uint32 _srcEid)
        internal
        returns (uint256 amountReceivedLD)
    {
    ...
    function _sentToken(address _from, uint256 _amountLD, uint256 _minAmountLD, uint32 _dstEid)
        internal
        returns (uint256 amountSentLD, uint256 amountReceivedLD)
    {
